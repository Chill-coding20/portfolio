        ...
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground">
              Java full stack developer and QA automation engineer building dependable web platforms.
            </p>
          ...
          <div className="text-sm">
            ...
            <ul className="mt-4 space-y-2 text-muted-foreground">
              ...
              <li>
                <a href={profile.github} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 transition-colors hover:text-foreground">
                  <Github className="size-4" aria-hidden /> GitHub
                </a>
              </li>
              <li>
                <a href={profile.linkedin} target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 transition-colors hover:text-foreground">
